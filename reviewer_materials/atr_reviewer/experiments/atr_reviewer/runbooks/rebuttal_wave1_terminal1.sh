...
CUDA_VISIBLE_DEVICES=1 python3 src/run_continual_causal_llama2.py \
  ...
  --seed 0 \
  --atr_variant_name wo_atr \
  --output_dir checkpoints_continual_keshi_llama/atr_reviewer_suite/wo_atr \
...
CUDA_VISIBLE_DEVICES=1 python3 experiments/atr_reviewer/evaluate_variant.py \
  --experiment_dir checkpoints_continual_keshi_llama/atr_reviewer_suite/wo_atr \
  --per_device_eval_batch_size 1 \
  --max_final_test_batches 50

python3 tools/plot_atr_reviewer_stats.py \
  --data_dir checkpoints_continual_keshi_llama/atr_reviewer_suite/wo_atr/atr_reviewer_eval \
  --out_dir checkpoints_continual_keshi_llama/atr_reviewer_suite/wo_atr/atr_reviewer_eval/figures
