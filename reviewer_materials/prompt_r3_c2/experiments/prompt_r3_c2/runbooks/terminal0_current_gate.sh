...
CUDA_VISIBLE_DEVICES=0 python -m experiments.prompt_r3_c2.gate_probe \
  --mode current \
  ...
  --output-dir experiments/prompt_r3_c2/outputs/current \
  --cache-dir experiments/prompt_r3_c2/cache/current \
