...
CUDA_VISIBLE_DEVICES=3 python -m experiments.prompt_r3_c2.gate_probe \
  --mode learnable_mlp \
  ...
  --output-dir experiments/prompt_r3_c2/outputs/learnable_mlp \
  --cache-dir experiments/prompt_r3_c2/cache/learnable_mlp \
