...
# 定义固定路径
INPUT_DIR="./test_infer_RAG/generate_answer_rag_v1"
OUTPUT_DIR="./test_infer_RAG/generate_scores_modaDS_v1"
PYTHON_SCRIPT="./test_infer_RAG/generate_score_modaDS.py"
