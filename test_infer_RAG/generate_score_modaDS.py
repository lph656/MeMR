...
# 循环处理所有科室的评分文件并计算均分
def process_all_averages(score_dir="./test_infer_RAG/generate_scores_modaDS"):
    logger.info(f"Processing all score files in {score_dir}")
    #departments = ["erke", "fuchanke", "neike", "waike", "nanke", "zhongliuke"]
    #departments = ["erke", "neike", "waike"]
    departments = ["fuchanke", "nanke", "zhongliuke"]
...
def main():
    ...
    parser.add_argument("--score_dir", default="./test_infer_RAG/generate_scores_modaDS", help="评分文件目录（均分模式）")
